# Паттерны проектирования на C# и .NET

Учебная сайт-книга о классических паттернах проектирования и их применении на платформе .NET. Материал собран в виде коротких глав с описанием задачи, структуры, преимуществ, ограничений и примеров из .NET.

Читайте книгу на сайте: [666mxvbee.github.io/DesignPatterns](https://666mxvbee.github.io/DesignPatterns/)

## Оглавление

- [Порождающие паттерны](design-patterns/creational/README.md)
  - [Factory Method](design-patterns/creational/factory-method/README.md)
...
- [Структурные паттерны](design-patterns/structural/README.md)
...
- [Поведенческие паттерны](design-patterns/behavioral/README.md)
  ...
  - [Iterator](design-patterns/behavioral/iterator/README.md)
