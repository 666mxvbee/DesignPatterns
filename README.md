...
Конспект паттернов проектирования и их применение на платформе .NET. 

Конспект собран в виде коротких глав с описанием задачи, структуры, преимуществ, ограничений и примеров из .NET.
