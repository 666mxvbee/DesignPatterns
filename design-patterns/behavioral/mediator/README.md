...
```csharp title="Mediator.cs" linenums="1"
--8<-- "behavioral/mediator/Mediator.cs"
```

[Открыть `Mediator.cs` отдельно](Mediator-code.md){ .md-button }
[Скачать `Mediator.cs`](Mediator.cs){ .md-button .md-button--primary download }
